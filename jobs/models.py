...
class Job(BaseModel):
    ...
    industry = models.CharField(
        max_length=50,
        choices=IndustryEnum.choices,
        default=IndustryEnum.OTHER
    )
...
class JobApplication(BaseModel):
    ...
    user = models.ForeignKey('authentication.AuthUser', on_delete=models.CASCADE, related_name='applications')
